    ...
    >
      <div className="max-w-5xl mx-auto w-full grid md:grid-cols-2 gap-16 items-center">
        ...
        >
          ...
          <h2 className="text-4xl font-bold text-white mt-4 mb-6 leading-tight">
            コードを書くことが<br />
        ...
        >
          {[
            ...
            <motion.div
              ...
              className="border border-white/10 rounded-lg px-5 py-3 flex justify-between items-center group hover:border-white/30 transition-colors"
            >
              <span className="font-mono text-xs text-white/30 tracking-widest">{label}</span>
